...
this will open what is referred to as the "interactive shell." (Assuming that you have activated
your environment, of course; otherwise use `uv run python` instead.)
...
When you are ready to exit the interactive shell and return to the regular Terminal prompt,
