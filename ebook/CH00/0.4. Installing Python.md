...
> saying, "Hey uv, use pip to install these packages and track them in our project configuration."
...
name = "bcog200"
version = "0.1.0"
description = "BCOG 200 Course Project"
...
- **Install a package and track it**: `uv pip install package_name`
- **Install packages from requirements**: `uv pip install -r requirements.txt`
...
- **Update lockfile**: `uv pip freeze > requirements.txt`
...
7. Run a simple Python program to verify everything is working:
