...
Python's `turtle` library lets you create pictures and shapes by providing them with a virtual
canvas. It is all drawn by creating instances of a `Turtle` object on a drawing canvas.
...
places it at the center of a window. Turtle objects have attributes like their shape, size, and color,
