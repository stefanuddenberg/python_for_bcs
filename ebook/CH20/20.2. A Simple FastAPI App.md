...
Recall that we learned a bit about **JSON** in [Chapter 4.3](../CH04/4.3.%20JSON%20Files.md). To jog your memory, JSON is a standard format for representing data that can be easily read and written by computers and humans alike.
