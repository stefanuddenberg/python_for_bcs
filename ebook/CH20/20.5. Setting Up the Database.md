...
Now each time a participant submits the form, their response is saved to `survey.db`.
...
There are many other features we could add down the road, including exporting the database to CSV, a nicer experimenter view page, and more. But these provide all the basic functionality we need to get started.
