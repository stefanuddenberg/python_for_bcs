...
you may need to use `time.perf_counter()` instead of `time.time()` in order to see any appreciable differences 
for such computations. Computers just keep getting faster!
