...
As you go along with this lab, note that some of the questions will require you
to jump back and forth between different functions, as well as your main
function. This is because an important part of writing scripts is connecting
things up, which may mean working on different functions at the same time.
...
def q5():
    ...
    - if you encounter a error, meaning that the user inputs something that is not an integer/is not a positive integer,
