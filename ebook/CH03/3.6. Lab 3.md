...
Then create an "answer_questions" function that is called from the main functions, and put a print statement in it that,
...
2-5. Inside that function, create print statements answering the following questions:
    ...
    5. Run the simulation from book section 3.5. Run the simulation several times, at least 5 times. Describe what happens 
