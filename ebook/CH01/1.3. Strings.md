...
and then you can directly reference variables within the string by putting them inside curly braces. This makes
...
You can also use f-strings to do more complicated things, like calling functions or methods, because you can put valid
Python code inside the curly braces:

```python
name1 = "Stefan"
food1 = "PIZZA" # note that this is uppercase
rating1 = 10.0

sentence1 = f"{name1} likes {food1.lower()} with a rating of {rating1}"
print(sentence1)
