...
As you can see from the color coding, where I hit return makes Python think the string is over, and
it starts trying to interpret the rest of the text as Python code. So if we want to put in a line
break, we need to use the special newline "escape sequence", `\n` (i.e., a backslash followed by
`n`).
...
![Output with line break](https://user-images.githubusercontent.com/42456070/213057646-9ee0a333-ebf7-4c92-b925-7e239e1d2698.png)

In general, a backslash (`\`) works as an escape character, telling Python to do something special
with the next character. There are other escape characters that are sometimes useful:
...
![Terminal window showing output of string indexing and slicing](https://user-images.githubusercontent.com/42456070/213057046-b637a314-b943-408e-96ca-19ddd8ed5a15.png)
...
Next: [1.4. Numeric Data Types](1.4.%20Numeric%20Data%20Types.md)<br>
