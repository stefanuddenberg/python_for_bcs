...
We touched on type hints briefly in [Chapter 6.4 Data Classes](6.4.%20Data%20Classes.md), but we'll cover them in more
detail here. Although Python is a dynamically typed language, optional _type hints_ can help you catch errors and make
your code more readable. Some popular packages (e.g., FastAPI) all but require type hints for your variables in function
