...
Recall this snippet of a function from [3.5. An Example Program](../CH03/3.5.%20An%20Example%20Program.md):
...
However, f-strings can do more than just insert variables. For example, you can use them to format
numbers by using a colon (`:`) followed by a format specifier.
